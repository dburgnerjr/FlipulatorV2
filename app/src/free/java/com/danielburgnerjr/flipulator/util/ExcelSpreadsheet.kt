...
class ExcelSpreadsheet {
    ...
    fun createSpreadsheet(fDir: File, calC: Calculate, strXLSFile: String) {
        ...
        lblCityOrig = Label(0, 2, "City, State ZIP:", timesBold)
        ...
        lblSquareFootageOrig = Label(0, 4, "Square Footage:", timesBold)
        ...
        lblFMVARVOriginal = Label(0, 7, "FMV/ARV:", timesBold)
        ...
        lblSalesPriceOrig = Label(0, 9, "Sales Price:", timesBold)
        ...
        lblRehabOrig = Label(0, 11, "Rehab Budget:", timesBold)
        excelSheet.addCell(lblRehabOrig)
        val nbrRehabO = Number(3, 11, calC.getBudget(), wcfDollar)
        excelSheet.addCell(nbrRehabO)

        val lblClosHoldCosts: Label
        lblClosHoldCosts = Label(0, 13, "Clos/Hold Costs:", timesBold)
        ...
        lblNetProfitOriginal = Label(0, 15, "Net Profit:", timesBold)
        ...
        lblRateOfReturnOriginal = Label(0, 17, "Rate of Return:", timesBold)
        ...
        lblCashCashReturnOriginal = Label(0, 19, "Cash on Cash Return:", timesBold)
        excelSheet.addCell(lblCashCashReturnOriginal)

        buf = StringBuffer()
        buf.append("(D16/(D12+D14))")
        val forCashCashReturnSixMonthO = Formula(3, 19, buf.toString(), wcfPercent)
        excelSheet.addCell(forCashCashReturnSixMonthO)

        // budget items
        val lblBudgetItems: Label
        lblBudgetItems = Label(0, 21, "Budget Items:", timesBold)
        ...
        // rehab type
        val lblRehabType: Label
        lblRehabType = Label(0, 26, "Budget Based On:", timesBold)
        var strRehabType: String? = ""
        excelSheet.addCell(lblRehabType)
        strRehabType = calC.getRTSel()
